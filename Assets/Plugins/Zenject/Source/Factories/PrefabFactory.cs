...
namespace Zenject
{
    ...
    public class PrefabFactory<P1, P2, P3, P4, P5, T> : IFactory<UnityEngine.Object, P1, P2, P3, P4, P5, T>
        //where T : Component
    {
        [Inject]
        readonly DiContainer _container = null;
        ...
        public virtual T Create(UnityEngine.Object prefab, P1 param, P2 param2, P3 param3, P4 param4, P5 param5)
        {
            Assert.That(prefab != null,
                "Null prefab given to factory create method when instantiating object with type '{0}'.", typeof(T));

            return (T)_container.InstantiatePrefabForComponentExplicit(
                typeof(T), prefab, InjectUtil.CreateArgListExplicit(param, param2, param3, param4, param5));
        }
    }
}
